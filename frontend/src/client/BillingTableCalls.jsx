...
import { useState } from "react";
import ClientNavbar from "./components/ClientNavbar";
import { ArrowUpDown } from "lucide-react"; // Sorting icon
      ...
      <div className="overflow-x-auto overflow-y-auto border border-blue-500 rounded-md">
        <table className="w-full text-left border-collapse">
          <thead className="bg-gray-800">
            <tr>
              {[
                ...
                >
                  {header} <ArrowUpDown className="inline-block w-4 h-4" />
                </th>
              ))}
            </tr>
          </thead>
          <tbody>
            {paginatedData.map((row, index) => (
              <tr key={index} className="bg-gray-900">
                <td className="px-4 py-2 border border-gray-700">{row.contact}</td>
                <td className="px-4 py-2 border border-gray-700">
                  {row.date.toLocaleDateString()}
                </td>
                <td className="px-4 py-2 border border-gray-700">{row.duration}</td>
                <td className="px-4 py-2 border border-gray-700">{row.service}</td>
                <td className="px-4 py-2 border border-gray-700">{row.sessionCost}</td>
                <td className="px-4 py-2 border border-gray-700">{row.serverCost}</td>
                <td className="px-4 py-2 border border-gray-700">{row.charge}</td>
                <td className="px-4 py-2 border border-gray-700">{row.reference}</td>
              </tr>
            ))}
          </tbody>
        </table>
