    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <button onClick={() => navigate("/dashboard")} className={`px-4 py-2 rounded-md ${location.pathname === "/dashboard" ? "bg-white text-black" : "bg-gray-700"}`}>Overview</button>
          <button onClick={() => navigate("/dashboard-outgoing")} className={`px-4 py-2 rounded-md ${location.pathname === "/dashboard-outgoing" ? "bg-white text-black" : "bg-gray-700"}`}>Outgoing</button>
          <button onClick={() => navigate("/dashboard-incoming")} className={`px-4 py-2 rounded-md ${location.pathname === "/dashboard-incoming" ? "bg-white text-black" : "bg-gray-700"}`}>Incoming</button>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          {[['Call Volume', callVolumeData, ['incoming', 'red'], ['outgoing', '#4F46E5']],
