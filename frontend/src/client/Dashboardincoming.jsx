...
//           monthlyData[month] = monthlyData[month] || { name: month, incoming: 0, cost: 0 };
...
//         setAvgDuration(`${Math.floor(totalDuration / incomingCalls.length)}m ${totalDuration % 60}s`);
