...
//             <button className="bg-white text-black px-4 py-2 rounded-md">Overview</button>
//             <button className="bg-gray-700 px-4 py-2 rounded-md">Outgoing</button>
//             <button className="bg-gray-700 px-4 py-2 rounded-md">Incoming</button>
//           </div>
...
//           </div>
//           <div className="bg-gray-800 p-4 rounded-lg text-center">
//             <h3 className="text-gray-400">Avg. Call Duration</h3>
