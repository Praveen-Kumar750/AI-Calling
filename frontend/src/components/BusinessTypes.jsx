    ...
    <div className="bg-black text-white py-12 px-6 text-center">
      ...
      <div className="flex gap-[25px] w-[100px] justify-center mx-auto pb-[30px]">
        {businesses.map((business, index) => (
          <div 
            key={index} 
            className=" flex flex-col items-center w-[180px] h-[130px] bg-[linear-gradient(103.89deg,_rgba(255,255,255,0.25)_0%,_rgba(255,255,255,0.1)_162.2%)] p-6 rounded-lg transition-shadow duration-300 hover:shadow-lg hover:shadow-purple-500/50">
            {business.icon}
